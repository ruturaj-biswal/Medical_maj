...
export default function App() {
  ...
  // ----------------------------------------------
  // 🚨 Always force login when server restarts
  // ----------------------------------------------
  useEffect(() => {
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        {/* All your other pages protected */}
        <Route
          path="/doctors"
          element={
            <PrivateRoute>
        ...
        <Route
          ...
          element={
            <PrivateRoute>
              <PreventiveHealthCheckups />
            </PrivateRoute>
          }
        />

        <Route
          path="/book-health-package"
          element={
            <PrivateRoute>
              <BookHealthPackage />
            </PrivateRoute>
        ...
        <Route
          path="/depression-quiz-success"
          element={
            <PrivateRoute>
              <DepressionQuizSuccess />
            </PrivateRoute>
          }
        />
