...
app.config.update(
    ...
    MAIL_USE_TLS=True,
    MAIL_USERNAME=os.environ.get("MAIL_USERNAME", "munabiswal955@gmail.com"),
    MAIL_PASSWORD=os.environ.get("MAIL_PASSWORD", "fnazvueuxkyquliw"),  # Gmail App Password
    MAIL_DEFAULT_SENDER=("Health.io", os.environ.get("MAIL_USERNAME", "munabiswal955@gmail.com"))
)

mail = Mail(app)

# =====================================================================
# ✅ MYSQL DATABASE CONNECTION (with environment variables support)
# =====================================================================
def get_db_connection():
    ...
    try:
        connection = mysql.connector.connect(
            ...
            database=os.environ.get("DB_NAME", "healthio"),
            autocommit=False
        )
        return connection
